...
<head>
  ...
  <style>
    ...
    .slide-in-2 {
      animation: slideIn .7s .15s ease both;
      opacity: 0
    }
    ...
    select:focus,
    textarea:focus {
      box-shadow: 0 0 0 3px rgba(201, 241, 105, .1)
    }
...
<body class="font-sans">
  ...
  <div class="dash-layout">
    ...
    <main class="dash-main">
      ...
      <div class="flex items-start justify-between mb-7 anim anim-1">
        <div>
          <h1 class="font-serif text-3xl font-semibold tracking-tight">Members</h1>
          <p class="text-sm text-muted mt-1">4 active members · 1 invitation pending</p>
        </div>
      ...
      <div class="rounded-2xl border border-border overflow-hidden anim anim-3" style="background:#161616">
        <table class="w-full">
          <thead>
            <tr class="text-[11px] text-muted uppercase tracking-wider border-b border-border">
              <th class="text-left px-6 py-3">Member</th>
              <th class="text-left px-4 py-3">Role</th>
              <th class="text-left px-4 py-3">Joined</th>
              <th class="text-left px-4 py-3">Reputation</th>
          ...
          <tbody class="text-sm">
            ...
            <tr class="hover:bg-white/[.02] border-b border-border/50">
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-9 h-9 rounded-full bg-accent/20 text-accent text-xs font-bold flex items-center justify-center">AB</div>
                  <div>
              ...
              @if($member->is_owner)
                <td class="px-4 py-4"><span class="px-2 py-0.5 rounded text-[11px] font-semibold bg-accent2/10 text-accent2">Owner</span></td>
              @else
                <td class="px-4 py-4"><span class="px-2 py-0.5 rounded text-[11px] font-semibold bg-accent3/10 text-accent3">Member</span></td>
              @endif
              <td class="px-4 py-4 text-muted">Sep 12, 2024</td>
              <td class="px-4 py-4 font-semibold text-green-400">★ +5</td>
              <td class="px-4 py-4 font-semibold text-accent">+$142.50</td>
              @if($member->is_owner)
                <td class="px-4 py-4 text-xs text-muted">—</td>
              @else
                <td class="px-4 py-4"><button onclick="confirmRemove(this,'Marie Leroy')" class="px-3 py-1 rounded-lg text-xs font-medium bg-red-400/10 text-red-400 border border-red-400/20 hover:bg-red-400/20 transition-all">Remove</button></td>
              @endif
            </tr>
            @endforeach
            <!-- <tr class="hover:bg-white/[.02] border-b border-border/50">
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-9 h-9 rounded-full bg-accent3/20 text-accent3 text-xs font-bold flex items-center justify-center">ML</div>
                  <div>
                    <div class="font-medium">Marie Leroy</div>
                    <div class="text-xs text-muted">marie@email.com</div>
                  </div>
                </div>
              </td>
              <td class="px-4 py-4"><span class="px-2 py-0.5 rounded text-[11px] font-semibold bg-accent3/10 text-accent3">Member</span></td>
              <td class="px-4 py-4 text-muted">Sep 15, 2024</td>
              <td class="px-4 py-4 font-semibold text-green-400">★ +3</td>
              <td class="px-4 py-4 font-semibold text-red-400">-$67.50</td>
              <td class="px-4 py-4"><button onclick="confirmRemove(this,'Marie Leroy')" class="px-3 py-1 rounded-lg text-xs font-medium bg-red-400/10 text-red-400 border border-red-400/20 hover:bg-red-400/20 transition-all">Remove</button></td>
            </tr>
            <tr class="hover:bg-white/[.02] border-b border-border/50">
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-9 h-9 rounded-full bg-accent2/20 text-accent2 text-xs font-bold flex items-center justify-center">TK</div>
                  <div>
                    <div class="font-medium">Thomas Karim</div>
                    <div class="text-xs text-muted">thomas@email.com</div>
                  </div>
                </div>
              </td>
              <td class="px-4 py-4"><span class="px-2 py-0.5 rounded text-[11px] font-semibold bg-accent3/10 text-accent3">Member</span></td>
              <td class="px-4 py-4 text-muted">Sep 20, 2024</td>
              <td class="px-4 py-4 font-semibold text-red-400">★ -1</td>
              <td class="px-4 py-4 font-semibold text-red-400">-$75.00</td>
              <td class="px-4 py-4"><button onclick="confirmRemove(this,'Thomas Karim')" class="px-3 py-1 rounded-lg text-xs font-medium bg-red-400/10 text-red-400 border border-red-400/20 hover:bg-red-400/20 transition-all">Remove</button></td>
            </tr>
            <tr class="hover:bg-white/[.02]">
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-9 h-9 rounded-full bg-red-400/20 text-red-400 text-xs font-bold flex items-center justify-center">JR</div>
                  <div>
                    <div class="font-medium">Julie Renault</div>
                    <div class="text-xs text-muted">julie@email.com</div>
                  </div>
                </div>
              </td>
              <td class="px-4 py-4"><span class="px-2 py-0.5 rounded text-[11px] font-semibold bg-accent3/10 text-accent3">Member</span></td>
              <td class="px-4 py-4 text-muted">Oct 1, 2024</td>
              <td class="px-4 py-4 font-semibold text-green-400">★ +2</td>
              <td class="px-4 py-4 font-semibold text-green-400">$0.00</td>
              <td class="px-4 py-4"><button onclick="confirmRemove(this,'Julie Renault')" class="px-3 py-1 rounded-lg text-xs font-medium bg-red-400/10 text-red-400 border border-red-400/20 hover:bg-red-400/20 transition-all">Remove</button></td>
            </tr> -->
          </tbody>
        </table>
      </div>
      <div class="mt-4 rounded-2xl border border-border p-6 anim anim-4" style="background:#161616">
        ...
        <div class="flex items-center gap-4 p-4 rounded-xl border border-border/50" style="background:#1e1e1e">
          <div class="w-9 h-9 rounded-full border-2 border-dashed border-muted flex items-center justify-center text-muted text-lg flex-shrink-0">?</div>
          <div class="flex-1">
            <div class="text-sm font-medium">luc@email.com</div>
            <div class="text-xs text-muted">Invited Feb 24 · Expires Feb 27, 2025</div>
          </div><span class="px-2 py-0.5 rounded text-[11px] font-semibold bg-accent2/10 text-accent2">Pending</span><button class="px-3 py-1 rounded-lg text-xs font-medium border border-border text-muted hover:text-white hover:border-muted transition-all">Cancel</button>
        </div>
      </div>
      <!-- Invite modal -->
  ...
  <script>
    ...
    function confirmRemove(btn, name) {
      if (confirm('Remove ' + name + ' from the apartment? Outstanding debts will transfer to you as owner.')) {
